...
Allo stesso modo il resto degli elementi nella pagina sono iniziati come piccoli esperimenti con gli strumenti nelle slide si sono evoluti nella forma attuale (boneBox era nato con tag &lttable&gt ma le trasformazioni che subisce per le animazioni mi hanno costretto a cambiarlo).
